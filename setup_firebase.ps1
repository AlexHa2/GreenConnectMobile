...
function Test-ConfigFile {
    ...
    if (Test-Path $FilePath) {
        Write-Host "OK - $FilePath already exists" -ForegroundColor Green
        return $true
    } else {
        Write-Host "Missing - $FilePath not found" -ForegroundColor Yellow
        return $false
    }
}
...
Write-Host ""
Write-Host "IMPORTANT: Please update the Firebase configuration files with your actual credentials" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "For more information, visit Firebase documentation" -ForegroundColor Cyan
